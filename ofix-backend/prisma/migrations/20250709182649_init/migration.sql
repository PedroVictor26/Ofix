...
CREATE TABLE "Servico" (
    ...
    "valorTotalServicos" REAL,
    "valorTotalPecas" REAL,
    "valorTotalFinal" REAL,
    "kmEntrada" INTEGER,
    "checklist" TEXT,
    "observacoes" TEXT,
    "clienteId" TEXT NOT NULL,
...
CREATE TABLE "ItemServicoPeca" (
    ...
    "precoUnitarioCobrado" REAL NOT NULL,
...
CREATE TABLE "Financeiro" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "Financeiro_servicoId_fkey" FOREIGN KEY ("servicoId") REFERENCES "Servico" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
