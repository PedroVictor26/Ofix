  ...
  try {
    const newPeca = await prisma.peca.create({
      data: {
        ...
        fabricante,
        precoCusto: parseFloat(preco_custo) || 0,
        precoVenda: parseFloat(preco_venda) || 0,
        estoqueAtual: parseInt(quantidade) || 0,
        estoqueMinimo: parseInt(estoque_minimo) || 0,
        oficina: {
          connect: { id: oficinaId },
        },
        ...(fornecedor_id && { fornecedor: { connect: { id: fornecedor_id } } }),
      },
    });
