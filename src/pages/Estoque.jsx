...
export default function Estoque() {
    const { pecas, fornecedores, stats, isLoading, error, reload } = useEstoqueData();
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <header className="mb-8">
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                        <div>
                            ...
                            <p className="text-slate-500 mt-1">Gerencie suas peças e fornecedores.</p>
                        </div>
                        <div className="flex items-center gap-2">
                            <Button variant="outline" onClick={() => setFornecedorModalOpen(true)}>
                ...
                <main className="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
                    <div className="flex items-center justify-between mb-4">
                        <h2 className="text-xl font-semibold text-slate-800">Peças em Estoque</h2>
