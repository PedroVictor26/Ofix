...
import { User, Car, Phone, Mail, MapPin, Edit } from "lucide-react";
...
export function ClienteCard({ cliente, veiculos, servicos, onCardClick, onEditClick }) {
    return (
        <Card
                ...
                <div className="flex items-start justify-between gap-6">
                    ...
                    <div className="flex flex-col items-end justify-between h-full gap-4">
                        ...
                        <Button
                            ...
                            className="h-9 w-9 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                        >
