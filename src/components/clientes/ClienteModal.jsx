  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (cliente && cliente.id) {
        // Se tem cliente com ID, é uma atualização
        // TODO: Implementar lógica de atualização (PUT /api/clientes/:id)
        // await apiClient.put(`/clientes/${cliente.id}`, formData);
        console.warn(
          "Funcionalidade de editar cliente ainda não implementada com backend."
        );
        alert(
          "Funcionalidade de editar cliente ainda não implementada com backend."
        );
